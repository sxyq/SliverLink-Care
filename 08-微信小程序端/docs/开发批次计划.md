...
1. `src/subpackages/scan/verify/index.tsx`
2. `src/services/scan/scanArchiveService.ts`
3. `src/subpackages/scan/archive/index.tsx`
4. `src/subpackages/scan/medications/index.tsx`
5. `src/subpackages/scan/scales/index.tsx`
6. `src/pages/auth/login.tsx`
7. `src/pages/auth-role-redirect/index.tsx`
8. `src/services/workbench/authService.ts`
