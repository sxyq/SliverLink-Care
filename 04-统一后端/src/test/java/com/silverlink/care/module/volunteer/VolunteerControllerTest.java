...
class VolunteerControllerTest {
    ...
    void setUp() {
        ...
        controller = new VolunteerController(volunteerService, jwtTokenProvider, auditLogService, data);
    ...
    void coversVolunteerEndpoints() throws Exception {
        ...
        var loginOk = controller.login(Map.of("account", "vol1", "password", "pwd"), request);
        ...
        assertEquals(401, controller.login(Map.of("account", "vol1", "password", "bad"), request).getCode());
        ...
        assertEquals("token-reg", controller.register(registerRequest, request).getData().get("token"));
        ...
        assertEquals("token-vol2", controller.updateMyProfile(Map.of("account", "vol2"), auth, request).getData().get("token"));
